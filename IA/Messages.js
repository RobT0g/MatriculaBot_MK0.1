...
//talkat = 0
textkeep.welcome = ['Olá! Sou um bot programado para auxiliar o processo de matrícula do IFMA.',
    'Vejo que seu contato não está salvo no meu banco de dados.', 
    'Você gostaria de fazer uma nova matrícula?']

defaultans.welcome = ['Caso queria realizar uma nova matrícula, basta me enviar um "sim" ou ' +
    '"Quero realizar uma nova matrícula" a qualquer momento.']
